...
$classmap = [
  ...
  'Emails_model'          => INCLUDES_MODELS . "Emails_model.php",
  ...
  //        -- Emails
  'Email'                 => INCLUDES_VIEWS . 	"emails/Email.php",
  'Email_validate_view'   => INCLUDES_VIEWS . 	  "emails/Email_validate_view.php",
  'Email_forgotten_view'  => INCLUDES_VIEWS . 	  "emails/Email_forgotten_view.php",
  //				-- Popups
