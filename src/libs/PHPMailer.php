 ...
 *	$mail->AddAddress($tbl_response['mail']);
 *	$mail->AddReplyTo($replyTo);
 *	$mail->Subject= $subject;
 *	$mail->Body = stripslashes($body);
 *	$mail->Body.='<center><font face="Verdana, Arial, Helvetica, sans-serif" size="-2" >Vous souhaitez vous d&eacute;sinscrire de notre mailing liste, <a href="http://www.lacengalerie.com/includes/unsubscribe.php?email='.$tbl_response['mail'].'">cliquez ici</a></font></center>';
 *	$mail->Body.='<br></body></html>';
 *	if(!$mail->Send()){
 *	  echo $mail->ErrorInfo;
 *	}
 *	unset($mail);
...
class PHPMailer
{
	...
	{
        $this->ContentType = ($bool == true)?"text/html" : "text/plain";
    }
    ...
    */
    ...
    function CreateHeader() {
        ...
        $result .= $this->HeaderLine("X-Mailer", "Rob [version " . $this->Version . "]");
